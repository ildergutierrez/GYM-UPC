...
<head>
  ...
  <title>Apartado de Rutinas</title>
  <link
  ...
  <link rel="stylesheet" href="../../css/seccionrutinas.css" />
    ...
    <main>
      ...
      <div class="container" style="margin-top: 80px; ">
        <div id="nombre" class="d-flex Bienvenida" style="display: block;">
          <p>
          <h1 id="x2">APARTADO DE RUTINAS</h1>
          </p>
        </div>
      ...
      <div class="container">
        <div class="container">
          <center>
            <h1 style="color:#ffffff">MUSCULATURA</h1>
          </center>
        </div>
        <div class="planes">
          <div class="row">
            <div class="col-md-4">
              <a href="../view/tren_superior.php">
                <div class="fondo_superior">
                <div class="color">
                  <div class="nombre">TREN SUPERIOR</div>
                </div>
                </div>
              </a>
            </div>
            <div class="col-md-4">
              <a href="../view/tren_inferior.php">
                <div class="fondo_inferior">
                <div class="color">
                  <div class="nombre">TREN INFERIOR</div>
                </div></div>
              </a>
            </div>
            <div class="col-md-4">
              <a href="../view/predefinidas.php">
                <div class="fondo_predeterminado">
                  <div class="color">
                    <div class="nombre">PREDEFINIDAS</div>
                  </div>
                </div>
              </a>
            </div>
