                ...
                <div class="container-fluid" style="color: white">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav justify-content-end ms-auto mt-3 mb-2 mb-lg-0" style="width: 250%">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" style=" border-bottom: solid 4px #ffcc53; color: #ffffff; padding-right: 30px; font-weight: bold"><span class="material-symbols-outlined" style="vertical-align: middle">cardiology</span>
                                    IMC</a>
                            </li>
                        </ul>
                        <form
            ...
            <div class="container" id="Resultado" style="display: none; color: #FFFFFF; font-weight: bold; font-family: Poppins;">
                ...
                <div class="container-recomendaciones">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div id="indice" style="color: #000000; text-align: justify;  padding: 10px; width: 90%;"></div>
                        </div>
                    </div>
                </div><br><br><br><br>
            </div>
